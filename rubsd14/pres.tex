...
\begin{frame}
	\frametitle{Once upon a time... the binary packages \\ жил был...бинарные пакеты}
...
\begin{frame}
	\frametitle{Once upon a time... the ports tree \\ жил был... дерево портов}
