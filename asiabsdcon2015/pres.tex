	...
	\begin{itemize}
		...
		\item Linux:
			\begin{itemize}
				...
				\item yum/rpm: full featured, GPLv2, no library, slow
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item BSD license
		\item Portable
		\item Extensible (ucl keywords, plugins)
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Binary centric
		\item Sanboxed
		\item Signing support
		\item Cross installation friendly
		\item Rethink \{pre,post\}-\{install,deinstall\} script
		\item Event based
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item pkg: \\ \small \url{https://github.com/freebsd/pkg}
		\item \normalsize issues: \\ \small \url{https://github.com/freebsd/pkg/issues} \\
		\item \normalsize introduction: \\ \small \url{https://www.freebsd.org/doc/handbook/pkgng-intro.html}
		\item \normalsize packaging base: \\ \small \url{https://svnweb.freebsd.org/base/projects/release-pkg}
	\end{itemize}
\end{frame}
